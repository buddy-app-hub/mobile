...
class NewMeetingBottomSheet {
  void show(BuildContext context, Connection connection) {
    ...
    showModalBottomSheet(
      ...
      builder: (context) {
        return Container(
          ...
          // height: 1500,
          child: 
          NewMeetingPage(connection: connection, scaffoldContext: scaffoldContext,),
        );
      },
    );
  }
...
class NewMeetingPage extends StatefulWidget {
  ...
  const NewMeetingPage({Key? key, required this.connection, required this.scaffoldContext}) : super(key: key);
  @override
